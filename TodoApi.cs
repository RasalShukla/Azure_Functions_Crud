...
namespace MyFirstFunctionApp
{
    public static class TodoApi
    {
        ...
        public static async Task<IActionResult> CreateTodo(
             ...
             ILogger log)
        {
            log.LogInformation("Execute CreateTodo Method");
            ...
            ILogger log)
        {
            ...
            log.LogInformation("Execute GetTodos Method");
            return new OkObjectResult(segment.Select(Mapping.ToTodo));
        ...
        {
            log.LogInformation("Execute GetTodoById Method");
            if (todo == null)
            {
       ...
       ILogger log, string id)
        {
            log.LogInformation("Execute UpdateTodo Method");
            string requestBody = await new StreamReader(req.Body).ReadToEndAsync();
